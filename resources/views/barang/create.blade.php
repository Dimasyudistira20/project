        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3" method="POST" action="{{ route('barang.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="nama_barang" class="form-control @error('nama_barang') is-invalid @enderror" id="input13" value="{{ old('nama_barang') }}" placeholder="Nama Barang" required>
                    @error('nama_barang')
